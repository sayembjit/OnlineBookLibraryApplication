...
import com.mottakin.onlineBookLibraryApplication.exception.BookReservedBeforeException;
...
public interface UserService {
    ...
    public BorrowReturnEntity bookBorrow(Long bookId) throws Exception, BookNotAvailable;
    ...
    public BookReserveEntity reserveBook(Long bookId) throws Exception, BookReservedBeforeException;
}
